...
public class Ecq220SelectRestaurantsController : AbstractApiAsyncControllerNotToken<Ecq220SelectRestaurantsRequest, Ecq220SelectRestaurantsResponse, List<Ecq220RestaurantEntity>>
{
    ...
    public Ecq220SelectRestaurantsController(IRestaurantService restaurantService)
    {
    ...
    {
        return await _restaurantService.SelectRestaurants();
    }
