...
public class Ecq300PaymentPremierCallbackController : AbstractApiAsyncController<Ecq110PaymentCallbackRequest, Ecq110PaymentCallbackResponse, Ecq110PaymentCallbackEntity>
{
    ...
    public Ecq300PaymentPremierCallbackController(IPaymentService paymentService, IIdentityApiClient identityApiClient)
    {
    ...
    {
        return _paymentService.PaymentPremierAccountCallBack(request, _identityEntity);
    }
