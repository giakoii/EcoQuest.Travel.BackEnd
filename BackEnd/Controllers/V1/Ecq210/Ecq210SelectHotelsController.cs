...
public class Ecq210SelectHotelsController : AbstractApiAsyncControllerNotToken<Ecq210SelectHotelsRequest, Ecq210SelectHotelsResponse, List<Ecq210HotelEntity>>
{
    ...
    public Ecq210SelectHotelsController(IHotelService hotelService)
    {
    ...
    {
        return await _hotelService.SelectHotels();
    }
