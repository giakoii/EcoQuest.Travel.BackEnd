...
public class Ecq230SelectAttractionsController : AbstractApiAsyncControllerNotToken<Ecq230SelectAttractionsRequest, Ecq230SelectAttractionsResponse, List<Ecq230AttractionEntity>>
{
    ...
    public Ecq230SelectAttractionsController(IAttractionService attractionService)
    {
    ...
    {
        return await _attractionService.SelectAttractions();
    }
