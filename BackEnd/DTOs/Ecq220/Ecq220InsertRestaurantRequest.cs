...
public class Ecq220InsertRestaurantRequest : AbstractApiRequest
{
    ...
    [Required(ErrorMessage = "Please insert at least one image of your restaurant.")]
    public List<IFormFile> RestaurantImages { get; set; } = null!;
}
