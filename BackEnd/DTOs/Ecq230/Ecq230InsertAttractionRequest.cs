...
public class Ecq230InsertAttractionRequest : AbstractApiRequest
{
    ...
    [Required(ErrorMessage = "Please insert at least one image of the attraction.")]
    public List<IFormFile> AttractionImages { get; set; } = null!;
}
